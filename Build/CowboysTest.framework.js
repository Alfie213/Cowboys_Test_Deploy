...
var ASM_CONSTS = {
  3567536: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3567597: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3567661: function() {return Module.webglContextAttributes.powerPreference;},  
 3567719: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3567774: function($0) {performance.now = function() { return $0; };},  
 3567822: function($0) {performance.now = function() { return $0; };},  
 3567870: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _GetTelegramUserId(callback) {
          try {
              // Validation
              /*
              ...
              fetch('/validate_telegram_data', {
                  ...
                  .then(data => {
                      if (data.isValid) {
                          ...
                          console.log("Valid Telegram User ID:", userId);
                          const buffer = stringToNewUTF8(userId.toString());
                          (function(a1) {  dynCall_vi.apply(null, [callback, a1]); })(buffer);
                          _free(buffer);
                      } else {
              ...
              */
              ...
              fetch('https://jsonplaceholder.typicode.com/posts/1')
                  ...
                  .then(data => {
                      ...
                      console.log("Received ID from JSONPlaceholder:", userId);
                      const buffer = stringToNewUTF8(userId);
                      (function(a1) {  dynCall_vi.apply(null, [callback, a1]); })(buffer);
                      _free(buffer);
                  })
                  .catch(error => {
                      console.error("Error in GetTelegramUserId with JSONPlaceholder:", error);
                      const buffer = stringToNewUTF8("0");
                      (function(a1) {  dynCall_vi.apply(null, [callback, a1]); })(buffer);
                      _free(buffer);
                  });
          } catch (error) {
              console.error("Unexpected error in GetTelegramUserId:", error);
              const buffer = stringToNewUTF8("0");
              (function(a1) {  dynCall_vi.apply(null, [callback, a1]); })(buffer);
              _free(buffer);
          }
...
var asmLibraryArg = {
  ...
  "GetTelegramUserId": _GetTelegramUserId,
